...
public class IllMorseScript : MonoBehaviour
{
    ...
    private static readonly string[] wordList = new string[]
        {
            ...
            "IAMBS", "ICHOR", "ICING", "ICONS", "IDEAL", "IDEAS", "IDIOM", "IDIOT", "IDLED", "IDOLS", "IDYLL", "IGLOO", "ILIAC", "ILIUM", "IMAGE", "IMBUE", "IMPLY", "INANE", "INDEX", "INDIA", "INERT", "INFER", "INGOT", "INLAY", "INLET", "INNER", "INPUT", "INTRO", "IRATE", "IRISH", "IRONY", "ISLES", "ISSUE", "ITCHY", "ITEMS", "IVORY",
            "JADED", "JAPAN", "JACKS", "JEANS", "JELLY", "JEWEL", "JOINS", "JOINT", "JOKER", "JOKES", "JOLLY", "JOULE", "JOUST", "JUDGE", "JUDGY", "JUICE", "JUICY", "JUMBO", "JUMPS",
            "KABOB", "KANJI", "KARAT", "KARMA", "KAYAK", "KAZOO", "KEBOB", "KEEPS", "KICKS", "KILLS", "KIOSK", "KINDA", "KINDS", "KINGS", "KITTY", "KNAVE", "KNEAD", "KNEEL", "KNEES", "KNELT", "KNIFE", "KNOBS", "KNOCK", "KNOLL", "KNOTS", "KNOWN", "KNOWS", "KOALA", "KRILL", "KUDOS", "KUGEL", "KUNAI",
            ...
            "QUACK", "QUAIL", "QUAKE", "QUALM", "QUARK", "QUART", "QUASH", "QUEEN", "QUELL", "QUERY", "QUESO", "QUEST", "QUEUE", "QUICK", "QUIET", "QUILL", "QUILT", "QUIRK", "QUITE", "QUITS", "QUOTA", "QUOTE",
            ...
            "XENON", "XERIC", "XEROX", "XERUS",
            "YACHT", "YANKS", "YARDS", "YAWNS", "YEARN", "YEARS", "YEAST", "YELLS", "YIELD", "YIKES", "YODEL", "YOLKS", "YOUNG", "YOURS", "YOUTH", "YOWLS", "YOWZA", "YUMMY", "YURTS",
            "ZEBRA", "ZEALS", "ZILCH", "ZINGY", "ZONED", "ZONES", "ZOOMS", "ZYGIA"
        };

    private int[] totalCounters = new int[26];
    private int[] currentCounters = new int[26];
    ...
    private void Start()
    {
        ...
        GenerateLetters();
        // This array allows X amount of words to generate without a specific letter in the alphabet being present.
        // (e.g. There can be 35 words without a Z until the module forces a word with a Z to be generated.)
        // These values are all different to make sure that the mod never gets stuck looking for a word with an X AND a J AND a Z and a... you get it.
        totalCounters = Enumerable.Range(20, 30).ToArray().Shuffle().Take(26).ToArray();
    ...
    void DisplayRandomWord(char[] letters, string[] shuffledMorseCodes)
    {
        ...
        int[] wordScores = {
            ...
            14, 9, 9, 12, 11, 7, 10, 11, 14, 7, 11, 8, 10, 7, 7, 8, 8, 7, 7, 8, 7, 10, 10, 8, 7, 7, 12, 7, 11, 7, 10, 7, 9, 7, 7, 13, 10, 10, 14, 14, 10, 10, 12, 12, 10, 13, 10, 12, 12, 10, 16, 14, 10, 10, 10, 16, 13, 11, 10, 10, 12, 10, 12, 10, 11, 10, 10, 16, 14, 10, 8, 8, 12, 8, 7, 12, 10, 9, 11, 10, 7, 10, 7, 7, 7, 11, 13, 13, 11, 8, 11, 13, 7, 7, 10, 8, 7, 10, 10, 9, 13, 7, 8, 11, 12, 7, 7, 9, 
            7, 7, 5, 7, 9, 7, 7, 6, 6, 9, 8, 11, 5, 5, 5, 8, 5, 7, 5, 5, 16, 9, 7, 7, 7, 5, 6, 5, 8, 6, 5, 5, 8,
            9, 8, 9, 8, 8, 11, 10, 8, 8, 11, 10, 8, 10, 9, 8, 10, 9, 11, 9, 9, 8, 8, 11, 8, 8, 8, 8, 8, 12, 15, 10, 13, 9, 10, 9, 8, 8, 13, 12, 11, 10,
            9, 9, 8, 8, 11, 12, 8, 17, 8, 9, 8, 8, 8, 13, 8, 12, 11, 8, 11, 11, 10, 9, 12, 12, 9, 8, 11, 11, 11, 11, 11, 16, 11, 11, 15, 11, 11, 11, 9, 9, 12, 12, 9, 8, 15, 10, 13, 9, 12, 8, 9, 11, 9, 8, 8, 13, 11, 11, 12, 10, 10, 9, 9, 12, 9, 10, 13, 11, 8, 8, 11, 9, 9, 11, 11, 14, 8, 8, 9, 8, 14,
            12, 19,
            13, 9, 11, 8, 8, 8, 8, 9, 9, 9, 8, 11, 15,
            16, 19, 18, 14
        };

        // Get a random word from the list, but weighted proportional to it's Scrabble score:
        int value = Rnd.Range(0, 18895); //This is the sum of every single word's Scrabble score
        int wordIx = -1;
        for (int w = 0; w < wordList.Length; w++) {
            if (value < wordScores[w]) {
                wordIx = w;
                break;
            } else {
                value -= wordScores[w];
        ...
        string randomWord = wordList[wordIx];
        */

        // Start out by not requiring any letters for the word.
        int? neededLetter = null;
        newWord:
        var wordListEdited = wordList.ToArray();
        
        if (neededLetter != null)
            // Edit the word list so that it only contains words which contains the needed letter.
            wordListEdited = wordListEdited.Where(x => x.Any(y => (y - 'A') == neededLetter)).ToArray();
        string randomWord = wordListEdited[Rnd.Range(0, wordListEdited.Length)];
        for (int i = 0; i < 26; i++)
            // If the <i>th letter in the alphabet has not appeared for <totalCounters[i]> words,
            // (AKA its counter is greater than or equal to a predetermined counter)
            // and the generated word does not contain that letter...
            if (currentCounters[i] >= totalCounters[i] && !randomWord.Select(j => j - 'A').ToArray().Contains(i))
            {
                // ...retry, and make sure that the new word contains the needed letter.
                neededLetter = i;
                Debug.LogFormat("<Ill Morse #{0}> Forcing a {1} into the word.", _moduleId, "ABCDEFGHIJKLMNOPQRSTUVWXYZ"[neededLetter.Value]);
                goto newWord;
            }
        // If the word contains the <i>th letter of the alphabet, reset its counter to 0, otherwise add 1 to its counter.
        for (int i = 0; i < 26; i++)
        {
            if (randomWord.Select(j => j - 'A').ToArray().Contains(i))
                currentCounters[i] = 0;
            else
                currentCounters[i]++;
        }
        // If the target counters ever accidentally sync up, reset the counters to ensure that the module doesn't
        // get held up/freeze due to trying to find words containing multiple rare letters are required.
        if (Enumerable.Range(0, 26).Count(i => currentCounters[i] >= totalCounters[i] && !randomWord.Select(j => j - 'A').ToArray().Contains(i)) > 1)
        {
            totalCounters = Enumerable.Range(20, 30).ToArray().Shuffle().Take(26).ToArray();
            currentCounters = new int[26];
        }
